...
class _ApiClient implements ApiClient {
  _ApiClient(
    ...
    baseUrl ??= 'https://api.shipora.io/api/';
  }
  ...
  Future<ForgotPasswordOtpResponse> forgotPasswordOtp(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ForgotPasswordOtpResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ForgotPasswordOtpResponse.fromJson(_result.data!);
    return value;
  }
